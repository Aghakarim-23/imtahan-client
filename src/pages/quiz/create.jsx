...
export default function QuizCreatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Mock: simulate API returning a quiz ID
      await new Promise((r) => setTimeout(r, 600));
      const quizId = Math.floor(Math.random() * 90000) + 10000;

      // Redirect to questions page with the quiz ID
      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} noValidate>
            {/* Quiz title */}
            <div className="mb-5">
              <label htmlFor="title" className="block text-xs font-medium text-gray-500 mb-1.5 tracking-wide uppercase">
              ...
              <div className="flex items-start justify-between mt-1">
                ...
                <p className={charCountClass(titleLen, 90, 100)}>{titleLen} / 100</p>
              </div>
            ...
            {/* Quiz description */}
            <div>
              <label htmlFor="description" className="block text-xs font-medium text-gray-500 mb-1.5 tracking-wide uppercase">
              ...
              <div className="flex items-start justify-between mt-1">
                ...
                <p className={charCountClass(descLen, 450, 500)}>{descLen} / 500</p>
              </div>
